...
export function ReviewPanel() {
  ...
  const totals = computeTotals(catalog, lines);
  ...
  return (
    <aside className={styles.panel} aria-label="Order review">
      <div className={styles.grid}>
        {/* Left column: the itemized system */}
        ...
        {/* Right column: guarantee + totals + checkout */}
        <div className={styles.right}>
          {/* Narrow panel -> badge + total on one row (returns text hidden). */}
